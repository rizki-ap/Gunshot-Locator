...
fil1 = 'ruger_1b_chan0_v0.wav'; % You can use your own file name
fil2 = 'ruger_1b_chan1_v0.wav'; % You can use your own file name
fil3 = 'ruger_1b_chan2_v0.wav'; % You can use your own file name
fil4 = 'ruger_1b_chan3_v0.wav'; % You can use your own file name
fil5 = 'ruger_1b_chan4_v0.wav'; % You can use your own file name
fil6 = 'ruger_1b_chan5_v0.wav'; % You can use your own file name
fil7 = 'glock3_chan6_v0.wav'; % You can use your own file name
fil8 = 'glock3_mean_v0.wav'; % You can use your own file name
%D:\WORK\GunShotLocator\Dataset\edge-collected-gunshot-audio\glock_17_9mm_caliber
% Read the audio file
[y1, Fs] = audioread(fil1); 
[y2, Fs] = audioread(fil6); 
